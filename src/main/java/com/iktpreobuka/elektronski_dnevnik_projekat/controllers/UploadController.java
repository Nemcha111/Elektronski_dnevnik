...
public class UploadController {
	...
	public String singleFileUpload(@RequestParam("file") MultipartFile file, RedirectAttributes redirectAttributes) {  //("file") -- ovo je elian, samo dodeljuje ime parametru. AKo se ne stavi zvao bi se kao naziv parametra 
